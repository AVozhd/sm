          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-6 col-12 section4-text">
              <div className="sec4-2">
                <p>
                  Ты научишься находить «свою» аудиторию, разрабатывать
                  SMM-стратегию и контент-план, автоматизировать свой блог с
                  помощью сервисов оптимизации, увеличивать вовлеченность и
                  получать клиентов. А еще — измерять эффективность своих
                  действий.
                </p>
                <p>
                  Уже прямо сейчас ты можешь получить СПИСКОК ЛУЧШИХ СЕРВИСОВ
                  ДЛЯ ОПТИМИЗАЦИИ INSTAGRAM совершенно бесплатно. Нажми на
                  кнопку ниже!
                </p>
                <Button
                  btntext="СПИСОК БЕСПЛАТНО"
                  btnclass="section4-btn"
                  blank={true}
                  btnlink="http://self-marketing.getcourse.ru/page1#obichnayaforma"
                />
              </div>
            </div>
          </div>
